...
[English README](../README.md) · [配置参考](configuration.md) · [迁移指南](migration.md)
...
完整示例见 [`examples/standard.typ`](../examples/standard.typ) 与 [`examples/wide.typ`](../examples/wide.typ)。
